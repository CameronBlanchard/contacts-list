...
function loadContacts() {
  let getContacts = JSON.parse(window.localStorage.getItem('contacts'))
  if (getContacts) {
  ...
  contacts.forEach(contact => {
    ...
    <div class="contact-card ${contact.emergencyContact ? 'emergency-contact' : ''}">
        ...
        <div class="d-flex space-between">
          <p>
            <i class="action fa fa-fw fa-phone"></i>
...
function removeContact(contactId) {
  let i = contacts.findIndex(contact => contact.id == contactId)
  if (i == -1) {
